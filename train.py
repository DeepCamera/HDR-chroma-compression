"""Training script for HDR chroma compression of RGB images (paired image-to-image translation) using generative adversarial networks.
...
At a minimum, you need to specify the dataset path ('--dataroot'). Models at each checkpoint are saved in '--checkpoints_dir'.

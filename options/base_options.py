...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--init_gain', type=float, default=0.1, help='scaling factor for normal, xavier and orthogonal.')
        parser.add_argument('--no_dropout', action='store_true', help='no dropout for the generator')
        parser.add_argument('--lambda_L1', type=float, default=100.0, help='weight for L1 loss')
        parser.add_argument('--lambda_Hue', type=float, default=10.0, help='weight for hue loss (L2)')
        # dataset parameters
    ...
    def gather_options(self):
        ...
        model_option_setter = models.get_option_setter('pix2pix')
        parser = model_option_setter(parser, self.isTrain)
        opt, _ = parser.parse_known_args()  # parse again with new defaults

        # modify dataset-related parser options
        dataset_option_setter = data.get_option_setter('aligned')
